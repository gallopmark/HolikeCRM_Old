...
public class MonthLableView extends View {
    ...
    private static final int defaultLableWeekendTextColor = Color.parseColor("#FF6E00");
    private static final int defaultLableTextColor = Color.parseColor("#000000");
    ...
    public MonthLableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int defaultLableTextSize = Utils.sp2px(context, 13);
