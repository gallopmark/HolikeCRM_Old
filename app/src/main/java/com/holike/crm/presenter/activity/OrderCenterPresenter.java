...
public class OrderCenterPresenter extends BasePresenter<OrderCenterView, OrderCenterModel> {
    ...
    private static class OrderListAdapter extends CommonAdapter<MultiItem> {

        OrderListAdapter(Context context, List<MultiItem> mDatas) {
    ...
    public void setAdapter(RecyclerView recyclerView) {
        adapter = new OrderListAdapter(recyclerView.getContext(), mBeans);
