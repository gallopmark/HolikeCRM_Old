...
public class TerminalCheckModel implements BaseModel {
    ...
    public void getData(String cityCode, String type, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_TERMINAL_CHECK_REPORT, null, params, 60, new RequestCallBack<TerminalCheckBean>() {
            @Override
