...
public class CollectDepositModel implements BaseModel {
    /**
     * 获取收取订金列表数据
     *
     * @param pageIndex
    ...
    public void getData(String pageIndex, String pageSize, String searchContent, final GetDataListener listener) {
        ...
        MyHttpClient.post(UrlPath.URL_COLLECT_DEPOSIT_LIST, header, params, new RequestCallBack<List<CollectDepositListBean>>() {
            @Override
