...
public class PayDetailsModel implements BaseModel {
    ...
    public void getDataOnline(String creditAmount, String date, String id,
        ...
        MyHttpClient.postByCliId(UrlPath.URL_EDIT_STATUS, null, params, new RequestCallBack<String>() {

            @Override
            public void onFailed(String result) {
                listner.onFail(result);
            }
    ...
    public void getDataPayList(String id, String status, String relationId, PayDetailsListner listner) {
        ...
        params.put("relationId", relationId);
        params.put("status", status);
        MyHttpClient.postByCliId(UrlPath.URL_CONFIRM, null, params, new RequestCallBack<String>() {
