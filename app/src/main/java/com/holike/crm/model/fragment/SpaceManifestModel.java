...
public class SpaceManifestModel implements BaseModel {
    public void getData(String orderId,final SpaceManifestListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_GET_PRODUCT_LIST, header, params, new RequestCallBack<List<SpaceManifestBean>>() {
            @Override
