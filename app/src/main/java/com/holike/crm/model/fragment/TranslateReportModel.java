...
public class TranslateReportModel implements BaseModel {
    ...
    public void getData(String cityCode, String startTime, String endTime, String type, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_TRANSLATE_REPORT, null, params, 60, new RequestCallBack<TranslateReportBean>() {
            @Override
