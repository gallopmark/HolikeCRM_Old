...
public class PerformanceModel implements BaseModel {
    /**
     * 获取业绩报表数据
     *
     * @param cityCode
    ...
    public void getData(String cityCode, String selectTime, String type, String url, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(url, null, params, 60, new RequestCallBack<PerformanceBean>() {
            @Override
    ...
    public void getCupboardData(String cityCode, String time, String type, String url, final GetCupboardListener listener) {
        ...
        params.put("type", type);
        MyHttpClient.postByTimeout(url, null, params, 60, new RequestCallBack<CupboardBean>() {
            @Override
            public void onFailed(String result) {
                listener.failed(result);
            }
