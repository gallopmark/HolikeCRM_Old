...
public class OnlineDeclarationModel implements BaseModel {
    public void getData(String pageNo, String startTime, String endTime, String searchContent, OnlineDeclarationListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_COMPLAIN_LIST, null, maps, new RequestCallBack<List<PayListBean>>() {
            @Override
