...
public class ActiveMarketModel implements BaseModel {
    ...
    public void getData(String cityCode, String start, String end, String time, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_ACTIVE_MARKET_REPORT, null, params, 60, new RequestCallBack<ActiveMarketBean>() {
            @Override
            public void onFailed(String result) {
                listener.fainled(result);
            }
