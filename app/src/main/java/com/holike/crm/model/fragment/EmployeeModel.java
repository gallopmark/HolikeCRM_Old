...
public class EmployeeModel implements BaseModel {
    ...
    public void getEmployeeList(@NonNull String content, @NonNull String shopId, @NonNull String status, final GetEmployeeListListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_EMPLOYEE_LIST, header, params, 60, new RequestCallBack<List<EmployeeBean>>() {
            @Override
...
//        listener.onSuccess(testListBean());
//        MyHttpClient.postByTimeout(UrlPath.URL_GET_CUSTOMER_LIST, header, params, 60, new RequestCallBack<List<EmployeeBean>>() {
//            @Override
//            public void onFailed(String result) {
//                listener.onFailure(result);
//            }
...
//        });
    ...
    public void getStoreList(@NonNull OnGetStoreCallback callback) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_HOMEPAGE_DATA, null, params, 60, new RequestCallBack<HomepageBean>() {
            @Override
            public void onStart(Disposable d) {
            ...
            @Override
            public void onFailed(String result) {
                callback.onGetStoreFalure(result);
            }
    ...
    public void saveEmployee(Map<String, String> params, @NonNull OnSaveEmployeeCallback callback) {
        MyHttpClient.postByCliId(UrlPath.URL_EMPLOYEE_EDIT, null, params, new RequestCallBack<String>() {
            @Override
            public void onStart(Disposable d) {
    ...
    public void getEmployeeDetails(String userId, @NonNull OnGetEmployeeCallback callback) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_EMPLOYEE_DATA, null, params, 60, new RequestCallBack<EmployeeDetailBean>() {
            @Override
            public void onStart(Disposable d) {
                callback.onGetStart();
            }
    ...
    public void resetPassword(String userId, String newPassword, @NonNull OnResetPasswordCallback callback) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_EMPLOYEE_EDIT_PASSWORD, null, params, new RequestCallBack<String>() {
            @Override
            public void onStart(Disposable d) {
    ...
    public void getAuthInfo(@NonNull OnGetAuthInfoCallback callback) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_HOMEPAGE_DATA, null, params, 60, new RequestCallBack<HomepageBean>() {
            ...
            @Override
            public void onFailed(String result) {
                callback.onGetAuthInfoFailure(result);
            }

            @Override
            public void onSuccess(HomepageBean result) {
                List<EmployeeDetailBean.EmployeeAuthInfoBean> list = new ArrayList<>();
