...
public class FeedbackRecordModel implements BaseModel {
    ...
    public void getRecord(String pageNo, String pageSize, final GetRecordListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_FEEDBACK_RECORD, null, params, new RequestCallBack<List<FeedbackRecordBean>>() {
            @Override
