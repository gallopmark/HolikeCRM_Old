...
public class QuotationListModel implements BaseModel {
    public void getData(String orderId, final QuotationListListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_QUERY_QUOTE_INFO, header, params, new RequestCallBack<QuotationBean>() {
            @Override
