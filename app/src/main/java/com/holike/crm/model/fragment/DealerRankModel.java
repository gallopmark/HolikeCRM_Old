...
public class DealerRankModel implements BaseModel {
    ...
    public void getData(String cityCode, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_DEALER_RANK_REPORT, null, params, 60, new RequestCallBack<DealerRankBean>() {
            @Override
