...
public class OperationLogModel implements BaseModel {
    public void getData(String orderId, final OperationLogListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_SELECT_LOG_BY_SPACEID, header, params, new RequestCallBack<List<OpreationLogBean>>() {
            @Override
