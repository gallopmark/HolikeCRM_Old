...
public class OriginalBoardModel implements BaseModel {
    ...
    public void getData(String cityCode, String startTime, String endTime, String time, String type, final getDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_ORIGNAL_BOARD_REPORT, null, params, 60, new RequestCallBack<OriginalBoardBean>() {
            @Override
