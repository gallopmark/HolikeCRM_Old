...
public class ProductInfoModel implements BaseModel {
    public void getData(String orderId, final ProductInfoListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_QUERY_ORDER_BOM_INFO, header, params, new RequestCallBack<List<ProductInfoBean>>() {
            @Override
