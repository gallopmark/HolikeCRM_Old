...
public class OrderRankingModel implements BaseModel {
    ...
    public void getData(String cityCode, String type, String pageSize, String pageNo, String startTime, String endTime, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_ORDER_RANKINF_REPORT, null, params, 60, new RequestCallBack<OrderRankingBean>() {
            @Override
