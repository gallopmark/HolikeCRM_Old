...
public class ProductTradingModel implements BaseModel {
    ...
    public void getData(String cityCode, String selectTime, String type, final GetDataListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_PRODUCT_TRADING_REPORT, null, params, 60, new RequestCallBack<ProductTradingBean>() {
            @Override
