...
public class OnlineAttractReportModel implements BaseModel {

    public void getData(Map<String,String> params, OnlineAttractReportListener listener) {

        MyHttpClient.postByTimeout(UrlPath.URL_ONLINE_DRAINAGE_REPORT, null, params,60, new RequestCallBack<LineAttractBean>() {
