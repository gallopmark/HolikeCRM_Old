...
public class ReceivingScanModel implements BaseModel {
    ...
    public void submitCodeInfo(List<EventQRCodeScanResult> codes, final ReceivingScanListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_SUBMIT_CODE_INFO, header, params, new RequestCallBack<String>() {
            @Override
    ...
    public void getCodeInfo(String code, final ReceivingScanCodeListener listener) {
        ...
        header.put(Constants.CLIENT, SharedPreferencesUtils.getString(Constants.CLIENT, ""));
        MyHttpClient.postByCliId(UrlPath.URL_GET_CODE_INFO, header, params, new RequestCallBack<String>() {
            @Override
            public void onFailed(String result) {
                listener.failed(result);
            }
