...
public class CreditInquiryModel implements BaseModel {
    ...
    public void getData(String pageNo, CreditInquiryListener listener) {
        ...
        MyHttpClient.postByCliId(UrlPath.URL_CREDIT_CHECKING_DEALER, null, maps, new RequestCallBack<CreditInquiryBean>() {
            @Override
