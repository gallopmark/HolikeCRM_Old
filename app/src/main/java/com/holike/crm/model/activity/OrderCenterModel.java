...
public class OrderCenterModel implements BaseModel {
    /**
     * 获取订单中心数据
     *
     * @param content       搜索内容
    ...
    public void getOrderList(String content, String orderStatusId, String orderTypeId,
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_ORDER_LIST, null, params, 30, new RequestCallBack<String>() {
            @Override
    ...
    public void getTypeList(final GetTypeListListener listener) {
        MyHttpClient.postByCliId(UrlPath.URL_ORDER_CENTER_SELECT, null, null, new RequestCallBack<TypeListBean>() {
            @Override
            public void onFailed(String result) {
                listener.failed(result);
            }
