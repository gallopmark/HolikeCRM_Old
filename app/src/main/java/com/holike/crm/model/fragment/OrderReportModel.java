...
public class OrderReportModel implements BaseModel {
    ...
    public void getOrderReport(String cityCode, String startTime, String endTime, String type, String time, final GetOrderReportListener listener) {
        ...
        MyHttpClient.postByTimeout(UrlPath.URL_GET_DEPOSIT_REPORT, null, params, 60,
    ...
    public void getCompleteData(String cityCode, String type, final GetCompleteListener listener) {
        ...
        params.put("cityCode", cityCode);
        params.put("type", type);
        MyHttpClient.postByTimeout(UrlPath.URL_GET_MONTH_COMPLETE, null, params, 60, new RequestCallBack<List<MonthCompleteBean>>() {
            @Override
            public void onFailed(String result) {
                listener.failed(result);
            }
