...
//        refreshLayout.setRefreshFooter(new BallPulseFooter(mContext));
    ...
    public void logout() {
        new SimpleDialog(mContext).setDate(mContext.getString(R.string.my_logout),
                mContext.getString(R.string.dialog_logout_content), mContext.getString(R.string.cancel),
