...
public class EmployeeEditStepThreeFragment extends MyFragment<EmployeeAuthInfoPresenter, EmployeeAuthInfoView>
    ...
    private static List<EmployeeDetailBean.EmployeeAuthInfoBean> authInfoBeans;
    ...
    public static EmployeeEditStepThreeFragment newInstance(List<EmployeeDetailBean.EmployeeAuthInfoBean> beans) {
        authInfoBeans = beans;
    ...
    public void update(List<EmployeeDetailBean.EmployeeAuthInfoBean> infoBeans) {
        mPresenter.addAll(infoBeans);
    ...
    public String getAuthIds() {
        ...
        for (EmployeeDetailBean.EmployeeAuthInfoBean.PArrBean bean : mPresenter.getSelectItems()) {
