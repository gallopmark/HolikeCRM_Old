...
public class OrderDetailsFragment extends MyFragment<OrderDetailsPresenter, OrderDetailsView> implements ListMenuPopupWindow.ItemSelectListener, OrderDetailsView {
    ...
    public void getDetailsSuccess(OrderDetailsBean orderDetailsBean) {
        ...
        llRecommendedPrice.setVisibility(orderDetailsBean.getIsSalePrice().equals("0") ? View.GONE : View.VISIBLE);

        llDealerFactor.setVisibility(orderDetailsBean.getIsFactoryPrice().equals("0") ? View.GONE : View.VISIBLE);
        llPriceBefore.setVisibility(orderDetailsBean.getIsFactoryPrice().equals("0") ? View.GONE : View.VISIBLE);
        llPriceAfter.setVisibility(orderDetailsBean.getIsFactoryPrice().equals("0") ? View.GONE : View.VISIBLE);
