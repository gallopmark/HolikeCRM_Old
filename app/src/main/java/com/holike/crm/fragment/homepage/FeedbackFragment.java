...
public class FeedbackFragment extends MyFragment<FeedbackPresenter, FeedbackView> implements FeedbackView {
    ...
    protected void init() {
        ...
        homepageBean = (HomepageBean) getArguments().getSerializable(Constants.HOME_PAGE_BEAN);
    ...
    protected void showProblemList() {
        ...
        rvProblemClassify1.setAdapter(new CommonAdapter<HomepageBean.QuestionTypeDataBean>(mContext, homepageBean.getQuestionTypeData()) {
            @Override
