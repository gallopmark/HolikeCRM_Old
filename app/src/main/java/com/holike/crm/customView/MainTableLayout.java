...
public class MainTableLayout extends LinearLayout {
    ...
    public void selectTable(final int selectPostion) {
        final ViewGroup currentView = (ViewGroup) getChildAt(currentPosition);
        final ViewGroup selectView = (ViewGroup) getChildAt(selectPostion);
        ...
        ivSelect.setImageResource(iconSelect[selectPostion]);
        ...
        listener.onTabSelect(selectPostion);
        currentPosition = selectPostion;
    }
