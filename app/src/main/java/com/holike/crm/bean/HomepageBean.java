...
public class HomepageBean implements Serializable {
    ...
    private List<EmployeeDetailBean.EmployeeAuthInfoBean> authInfo;
    ...
    public List<EmployeeDetailBean.EmployeeAuthInfoBean> getAuthInfo() {
        return authInfo;
    }
    ...
    public static class NewDataBean implements Serializable {
        ...
        public void setScaleCount(String scaleCount) {
    ...
    public static class TypeListBean implements Serializable {
        ...
        private List<DistributionStoreBean> shopData;
