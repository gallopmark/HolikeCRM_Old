...
public class EmployeeDetailBean {
    ...
    private List<EmployeeAuthInfoBean> authInfo;
    ...
    public List<EmployeeAuthInfoBean> getAuthInfo() {
        return authInfo;
    }

    public static class EmployeeAuthInfoBean implements MultiItem, Serializable {
        private String pName;
        private List<PArrBean> pArr2;

        public String getName() {
            return pName;
        }

        public List<PArrBean> getArr2() {
            return pArr2;
        }
        ...
        public static class PArrBean implements MultiItem, Serializable {
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof PArrBean) {
                    return TextUtils.equals(actionId, (((PArrBean) obj).actionId)) && TextUtils.equals(actionName, (((PArrBean) obj).actionName));
                } else {
                    return false;
                }
            }
