...
public class MyJsonParser {
    ...
    public static int getCode(String json) {
        if (!hasCode(json)) return -1234456789;
        try {
    ...
    public static String getMsg(String json) {
        ...
        try {
            ...
            return message;
//            return getAsJsonObject(json).get("msg").getAsString();
        } catch (Exception e) {
            LogCat.e(e);
            return "";
        }
    ...
    public static String getReason(String json) {
        ...
        try {
            ...
            return message;
//            return getAsJsonObject(json).get("reason").getAsString();
        } catch (Exception e) {
            LogCat.e(e);
            return "";
        }
    ...
    public static <T> T fromJson(String json, Class<?> subclass) {
        try {
            return new Gson().fromJson(json, getSuperclassTypeParameter(subclass));
        } catch (Exception e) {
            return null;
        }
    }
